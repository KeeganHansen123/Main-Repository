...
public class QuestionSix extends JFrame{
	...
	public QuestionSix()
	{
		label.setText("What did Sir Christopher Cockerell invent?");
		panel.add(label);
		frame.add(panel);
		frame.pack();
		...
		button3.addActionListener(d -> QuestionSeven.main(null));
