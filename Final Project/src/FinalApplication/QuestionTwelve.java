...
public class QuestionTwelve extends JFrame{
	...
	private JButton button3 = new JButton("6");
	...
	{
		label.setText("How many sets of petals does a Tudor rose have?");
		panel.add(label);
		frame.add(panel);
		frame.pack();
		...
		button2.addActionListener(c -> QuestionThirteen.main(null));
	...
	public static void main(String[] args) {
		...
		QuestionTwelve frame = new QuestionTwelve();
		frame.setVisible(true);
	}
}